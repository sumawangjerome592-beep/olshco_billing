...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO assessments (student_id, school_year, semester, tuition_fee, miscellaneous_fee, laboratory_fee, other_fees, due_date) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("issdddds", $student_id, $school_year, $semester, $tuition_fee, $miscellaneous_fee, $laboratory_fee, $other_fees, $due_date);
